  ...
  <article class="section banner-block">
    <div class="banner">
      <div class="banner__background picturefill-background is-lazy">
        <span class="picturefill-background-source" :data-src="pageData.titlea"></span>
        <span
  ...
  data () {
      return {
        pageData: {
          ...
          "imgSrc1: "https://picsum.photos/767/275?image=20",
          "imgSrc1: "https://picsum.photos/991/260?image=30",
          "imgSrc1: "https://picsum.photos/1500/400?image=35",
          "text": "<p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Voluptate tenetur officiis excepturi porro ducimus ab provident,
                quas temporibus ratione illo quae neque cupiditate totam facere
