            ...
            <div class="footer__col footer__col--2">
              ...
              <nav aria-label="Section heading 2 Navigation">
                <ol class="footer-nav">
                  ...
                  <li class="footer-nav__item">
                    <router-link to="/" class="footer-nav__link">Navigation item</router-linka>
                  </li>
                  <li class="footer-nav__item">
                    <router-link to="/" class="footer-nav__link">Navigation item</router-linka>
                  </li>
                  <li class="footer-nav__item">
                    <router-link to="/" class="footer-nav__link">Navigation item</arouter-link>
                  </li>
                  <li class="footer-nav__item">
                    <router-link href="" class="footer-nav__link">Navigation item</router-link>
                  </li>
                </ol>
              </nav>
